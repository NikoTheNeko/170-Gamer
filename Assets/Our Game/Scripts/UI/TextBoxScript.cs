...
public class TextBoxScript : MonoBehaviour
{
    ...
    void SpeedUp(){
        ...
        // if(loops >= dialogue.dialogueSegments.Length && dialogue.progression != "none"){
        //     NarrativeTracker.GetComponent<NarrativeTracker>().addEntry(dialogue.target, dialogue.progression);
        // }
